...
<div class="white-box p-3" style="background:white; text-align:center; height: 100%;" id="printableArea">
    ...
    <div class="row justify-content-start"><a href="#" class="btn btn-sm btn-success mt-5" onclick="window.print()">Print Preview</a></div>
    <div class="row pt-5 justify-content-end">
        <div class="col-sm-4 border-right-0 border">
            <div class="row">
                <div class="col">
                    <select name="tahun" id="" class="form-control main-select2 border-0">
            ...
            <div class="row">
                <div class="col border-top">
                    <div class="row justify-content-between">
                        <input type="datetime-local" name="masa_tamat" id="" class="form-control col-5 border-0">
                        <p>هيڠݢ</p>
                        <input type="datetime-local" name="masa_mula" id="" class="form-control col-5 border-0">
                    </div>
                </div>
        ...
        <div class="col-sm-4 border">
            <div class="row">
                <div class="col">
                    <select name="tajuk" id="" class="form-control border-0 text-sm-right">
    ...
    <div class="row justify-content-end pt-3">
        <div class="col-6">
            <input type="text" class="form-control" value="القرءان">
        </div>
